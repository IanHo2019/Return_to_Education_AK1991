* This do file replicates Table VIII in Angrist & Krueger (1991).
* Author: Ian Ho
* Date: Nov 1, 2023
********************************************************************************
...
* Select samples
keep if census == 1980 & cohort == 3 & race == 1
...
drop S15 // no black men in Hawaii
...
global controls = "smsa married neweng midatl soatl enocent esocent wnocent wsocent mt"
...
estout model1 model2 model3 model4 model5 model6 model7 model8 using "Tables\Table_8.tex", ///
